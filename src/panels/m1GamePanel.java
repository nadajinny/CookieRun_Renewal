...
public class m1GamePanel extends JPanel {
    ...
    public m1GamePanel(JFrame superFrame, CardLayout cl, Object o) {
            ...
            public void run() {
                while (true) {
                    ...
                    if (foot > 1999 || c1.getHealth() < 1) {
                        ...
                        main.setGamePanel(new m1GamePanel(superFrame, cl, main));
